...
/// inside `range`. Inlined, eight rows carried their own casts and their
/// own copy of the bounds, and the lenient settings parser restated them a
/// third time; the ranges live beside the parser as named constants and the
/// card turns them through here.
